...
select  cars.id,brand,model,year_of_issue,price,color from cars where brand='Hyundai';
--#4 Display all Red and Blue cars
select  id,cars.brand,cars.model, color from cars where color='Red' or  color='Blue';
--#5 Display all cars where issued year between 2000 and 2010
select cars.brand,model,cars.year_of_issue from cars where  year_of_issue between  2000 and 2010;
...
select avg(cars.year_of_issue) AS average_year from cars;
--#8 Display the cars where brand equals to Audi, Toyota, Kia and Ford
select cars.brand,cars.model from cars where brand='Audi' or brand='Toyota' or brand='Kia' or brand='Ford';
--#9 Display cars where car’s model starts with ’T’
select cars.brand, model from cars where model ilike 'T%';
--#10 Display cars where car’s model ends with ‘e’;
select cars.brand, model from cars where model ilike '%e';
--#11 Display brands where contains only 5 symbols
select cars.brand, model from cars where model like '_____';
...
select  max(cars.price) ,min(price)from  cars;
--#14 Display all cars where car's brand not TOYOTA
select cars.brand,cars.model from cars where brand!='TOYOTA';
...
select * from cars order by year_of_issue desc offset 4 rows fetch next 11 rows only ;
--#17 Display cars where car's year of issue not between 1995 and 2005;
select *
from cars where year_of_issue between 1995 and 2005 ;
